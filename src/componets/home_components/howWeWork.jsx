            ...
            <section className="howWeWork">
                ...
                <div className="wrapper">
                    <div className="howWeWork-conteiner">
                        <h2>Приумножай свои активы <br /> на рынке криптовалют</h2>
                        <div className="howWeWork-conteiner-tiltle-mobile">
                            <h3>Приумножай свои <br /> активы на рынке <br /> криптовалют</h3>
                        </div>
                        <p>вместе с AXIOM CryptoDao</p>
                        <button className="button">Продукты</button>
                    </div>
                    <div className="howWeWorkRectangle-conteiner desktop">
                        <img className="howWeWorkRectangle" src={howWeWorkRectangle} alt="" />
                        <div className="howWeWorkRectangle-conteiner-title">
                            <div className="howWeWorkRectangle-conteiner-title-content">
                                <h2>Как мы <br /> работаем</h2>
                                <div className="line"></div>
                                <p>Вся работа выстроена <br /> через отдельно созданные <br /> ДАО фонды</p>
                            </div>
                        </div>
                        ...
                        <div className="howWeWorkRectangle-conteiner-content">
                            <div className="howWeWorkRectangle-conteiner-content-items">
                                ...
                                <div className="howWeWorkRectangle-item">
                                <img className="howWeWorkRectangle_itemTwo" src={howWeWorkRectangle_itemTwo} alt="" />
                                    <h2>Безопасность</h2>
                                    <p>
                                        Фонды AXIOM CryptoDao созданы и работают на смарт- <br />
                                        контрактах, что является гарантией безопасного хранения  <br />
                                        средств инвесторов, а так же обеспечивает полную  <br />
                                        прозрачность и безопасность средств. <br />
                                        <br />
                                        Инвестор владеет активами на своем кошельке, третьи лица <br />
                                        не могу получить к ним доступ, а значит средствам ничего <br />
                                        не угрожает.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="howWeWorkRectangle-conteiner mobile">
                        <img className="howWeWorkRectangle" src={howWeWorkRectanglemobile} alt="" />
                        <div className="howWeWorkRectangle-conteiner-title">
                            <div className="howWeWorkRectangle-conteiner-title-content">
                        ...
                        <div className="howWeWorkRectangle-conteiner-content">
                            <div className="howWeWorkRectangle-conteiner-content-items">
                                ...
                                <img className="howWeWorkRectangle_itemTwo" src={howWeWorkRectangle_itemTwo} alt="" />
                                    <h2>Безопасность</h2>
                                    <p>
                                        Фонды AXIOM CryptoDao созданы и работают на<br /> смарт-
                                        контрактах, что является гарантией  <br /> безопасного хранения 
                                        средств инвесторов, а так <br /> же обеспечивает полную  
                                        прозрачность и <br /> безопасность средств.<br />
                                        <br />
                                        Инвестор владеет активами на своем кошельке,<br /> третьи лица
                                        не могу получить к ним доступ, а <br /> значит средствам ничего 
                                        не угрожает.<br />
                                    </p>
                                </div>
                            </div>
