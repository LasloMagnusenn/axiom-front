...
const Dashboard = () => {
  ...
  const totalBTCBalance = useMemo(() => {return AAVEWBTCTokenBalance + wBTCDAOBalance}, [AAVEWBTCTokenBalance, wBTCDAOBalance]);
            ...
            <div className="parameters-conteiner-content">
              <div className="content_item btc">
                ...
                <h3>
                  ...
                  {formattedAAVEWBTCTokenBalance
                    ? toOptionalFixed(formattedAAVEWBTCTokenBalance, 2)
                    : "-"}
